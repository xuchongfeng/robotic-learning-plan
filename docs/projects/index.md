...
| [P06 自定义差速车](p06-diff-drive.md) | 第四篇 | 满分项 | 不用官方 TurtleBot 模型也能导航。 |
| [P07 MoveIt 2 抓取](p07-moveit-grasp.md) | 第五篇 | **G5 门禁** | 抓取放置 ≥ 8/10。 |
| [P08 MuJoCo 抓取闭环](p08-mujoco-loop.md) | 第六篇 | **G6 门禁** | 识别—规划—抓取成功率 ≥ 50%。 |
| [P09 ACT 或 SmolVLA](p09-vla.md) | 第六篇 | 满分项 | 有评测数字；不挡 G6。 |
| [P10 方向分流终章](p10-capstone.md) | 第七篇 | **G7 门禁** | 三选一可演示。 |
